...
export interface LaunchDotFunTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
  ...
  encodeFunctionData(functionFragment: "tokenUrl", values?: undefined): string;
...
export interface LaunchDotFunToken extends BaseContract {
  connect(runner?: ContractRunner | null): LaunchDotFunToken;
  waitForDeployment(): Promise<this>;

  interface: LaunchDotFunTokenInterface;
  ...
  tokenUrl: TypedContractMethod<[], [string], "view">;
  ...
  getFunction(nameOrSignature: "tokenUrl"): TypedContractMethod<[], [string], "view">;
