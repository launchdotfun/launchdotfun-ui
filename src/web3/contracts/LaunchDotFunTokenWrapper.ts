...
export interface LaunchDotFunTokenWrapperInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface LaunchDotFunTokenWrapper extends BaseContract {
  connect(runner?: ContractRunner | null): LaunchDotFunTokenWrapper;
  waitForDeployment(): Promise<this>;

  interface: LaunchDotFunTokenWrapperInterface;
